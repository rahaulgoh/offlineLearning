...
SCORE_TABLE = "edge_humid_anomaly_score"
...
MODEL_PATH = "/opt/edge/models/humidity/model_humid.pt"
META_PATH = "/opt/edge/models/humidity/humid_metadata.json"
...
def main():
    ...
    print(f"[infer_temp] start: tags={len(tags)} window={window_size} poll={POLL_SECONDS}s")
